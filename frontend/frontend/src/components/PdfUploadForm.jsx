...
import { FileText, Upload, AlertCircle, CheckCircle, X, ArrowRight } from 'lucide-react';
...
const PdfUploadForm = () => {
  ...
  return (
    <div className="glass-panel border rounded-2xl p-6 shadow-md transition-all h-full flex flex-col justify-between">
      <div>
